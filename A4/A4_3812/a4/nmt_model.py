...
class NMT(nn.Module):
    ...
    def encode(self, source_padded: torch.Tensor, source_lengths: List[int]) -> Tuple[torch.Tensor, Tuple[torch.Tensor, torch.Tensor]]:
        ...
        hidden_forwad , hidden_back = last_hidden[0], last_hidden[1]
        init_decoder_hidden = self.h_projection(torch.cat([hidden_forwad,hidden_back],1))
        
        cell_forwad , cell_back = last_cell[0], last_cell[1]
        init_decoder_cell = self.c_projection(torch.cat([cell_forwad, cell_back], 1))
